...
class Company(models.Model):
    ...
    safe_wallet_partner_id = fields.Many2one('res.partner', string="Safe Wallet Partner")
    odoo_wallet_partner_id = fields.Many2one('res.partner', string="Odoo Wallet Partner")
