...
class AccountInvoice(models.Model):
    ...
    global_credit_status = fields.Selection(
        ...
        compute="_compute_credit_requests_data",
        track_visibility="always",
    )
    global_lcc_amount_credited = fields.Float(
        string="LCC amount credited", compute="_compute_credit_requests_data"
    )
    global_lcc_amount_to_credit = fields.Float(
        string="LCC amount to credit", compute="_compute_credit_requests_data"
    )

    @api.one
    @api.depends("credit_request_ids")
    def _compute_credit_requests_data(self):
