...
class AccountInvoice(models.Model):
    ...
    credit_request_ids = fields.One2many('credit.request', 'invoice_id', string='Credit Requests')
    global_credit_status = fields.Selection([
        ('to_do', 'To do'),
        ('on_going', 'On going'),
        ('done', 'Done'),
    ], string='Global Credit Status', compute="_compute_global_credit_status", track_visibility="always")
